...
import { GithubIcon as Icon } from './GithubIcon';
...
describe('<GithubIcon />', () => {
	...
	it('should have a correct aria label', () => {
		expect(render(<Icon />)).toHaveAttribute('aria-labelledby', expect.stringContaining('githubIconTitle'));
		expect(render(<Icon />)).toHaveAttribute('aria-labelledby', expect.stringContaining('githubIconDesc'));
	});
