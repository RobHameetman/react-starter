...
import { CheckIcon as Icon } from './CheckIcon';
...
describe('<CheckIcon />', () => {
	...
	it('should have a correct aria label', () => {
		expect(render(<Icon />)).toHaveAttribute('aria-labelledby', expect.stringContaining('checkIconTitle'));
		expect(render(<Icon />)).toHaveAttribute('aria-labelledby', expect.stringContaining('checkIconDesc'));
	});
