...
import { SuccessIcon as Icon } from './SuccessIcon';
...
describe('<SuccessIcon />', () => {
	...
	it('should have a correct aria label', () => {
		expect(render(<Icon />)).toHaveAttribute('aria-labelledby', expect.stringContaining('successIconTitle'));
		expect(render(<Icon />)).toHaveAttribute('aria-labelledby', expect.stringContaining('successIconDesc'));
	});
