...
import { SortOrderAscIcon as Icon } from './SortOrderAscIcon';

describe('<SortOrderAscIcon />', () => {
	it('should render', () => {
	...
	it('should have a correct aria label', () => {
		expect(render(<Icon />)).toHaveAttribute('aria-labelledby', expect.stringContaining('sortOrderAscIconTitle'));
		expect(render(<Icon />)).toHaveAttribute('aria-labelledby', expect.stringContaining('sortOrderAscIconDesc'));
	});
