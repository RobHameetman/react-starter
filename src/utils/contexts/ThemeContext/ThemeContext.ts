...
/**
 * Checks that an `unknown` value is a {@link ThemeContext}.
 *
 * Requirements:
 ...
 *
 * @returns The determination that `value` is or is not a {@link ThemeContext}.
 */
export const isThemeContext = (value: unknown): value is ThemeContext =>
	isObject(value) &&
	/**
	 * value.isDark
	 */
