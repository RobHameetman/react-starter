...
/**
 * Compositional prop types for the {@link PageFooter} component.
 */
type ComposedProps = Stylable;

/**
 * Prop types for the {@link PageFooter} component.
 */
export interface PageFooterProps extends ComposedProps {
	/**
